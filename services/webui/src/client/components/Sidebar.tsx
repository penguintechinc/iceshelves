...
const navigation: NavCategory[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'Catalog', path: '/marketplace', icon: '🛒', roles: ['admin', 'maintainer'] },
      { label: 'Inventory', path: '/marketplace/inventory', icon: '📦', roles: ['admin', 'maintainer'] },
      { label: 'Deployments', path: '/marketplace/deployments', icon: '🚀', roles: ['admin', 'maintainer'] },
      { label: 'Clusters', path: '/marketplace/clusters', icon: '☸️', roles: ['admin'] },
      { label: 'Repositories', path: '/marketplace/repositories', icon: '📚', roles: ['admin'] },
      { label: 'Updates', path: '/marketplace/updates', icon: '🔄', roles: ['admin', 'maintainer'] },
    ],
  },
  {
    label: 'Management',
